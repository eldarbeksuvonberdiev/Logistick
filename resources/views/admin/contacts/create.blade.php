...
@section('content')
    <form action="{{ route('contacts.store') }}" method="POST" novalidate class="needs-validation">
        @csrf
                ...
                <div class="page-header">
                    <div class="page-header-left d-flex align-items-center">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Создать Контакт</h5>
                        </div>
                        <ul class="breadcrumb">
                                    ...
                                    <div class="tab-content pt-3">
                                        <div class="tab-pane fade show active" id="uzContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <textarea class="form-control" id="address_uz" name="address_uz" rows="2">{{ old('address_uz') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="enContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <textarea class="form-control" id="address_en" name="address_en" rows="2">{{ old('address_en') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="ruContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <textarea class="form-control" id="address_ru" name="address_ru" rows="2">{{ old('address_ru') }}</textarea>
                                            </div>
                                        </div>
                                    </div>

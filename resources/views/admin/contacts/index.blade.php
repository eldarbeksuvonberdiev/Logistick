                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ $contact->facebook }}"
                                                            target="_blank">{{ $contact->facebook ? 'Facebook' : '-' }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ $contact->instagram }}"
                                                            target="_blank">{{ $contact->instagram ? 'Instagram' : '-' }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ $contact->telegram }}"
                                                            target="_blank">{{ $contact->telegram ? 'Telegram' : '-' }}</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ $contact->youtube }}"
                                                            target="_blank">{{ $contact->youtube ? 'YouTube' : '-' }}</a>
                                                    </td>
                                                    <td>
